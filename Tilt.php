...
<script type='text/javascript'>
 var filename = "/Tilt/TiltRange/TiltRange.root";
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<center><h3 style="color:rgb(60, 128, 214);"><b>Tilt Angle</b></h3>
<?php
$line2 = $_GET["birthday"];
$line = $_GET["birthday2"];
...
<?php
$myfile2 = fopen("Tilt/E.txt", "w") or die("Unable to open file!");
$line2 = $_GET["birthday"];
$line = $_GET["birthday2"];
...
<button><type="button"><a href="Tilt/TiltRange/TiltRange.root">ROOT File</a></button>
</center>
