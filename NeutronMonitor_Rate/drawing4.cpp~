...
int main()
{
  ...
  for (int i=0; i<variable.size(); i++) {
    ...
    TString north = "/var/www/html/NeutronMonitor_Rate/data_PLOT/"+variable[i]+"month.txt"; //percorso
    ...
    n->SetTitle(name + "  Time Resolution: 1 month");
  ...
  mg->SetTitle("Neutron Monitor Rate Time Resolution: 1 Month");
