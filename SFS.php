...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
 <title>SOLAR POLAR FIELD STRENGTH</title>
...
<body>
  <div class="container">
    <div class="col-sm-3">
      <div class="fixed-condition text-center">
        <a href="/"><img class="profile-avatar" src="/static/img/me.png" height="75px" width="75px" /></a>
        <h4 class="author-name" style="color:rgb(60, 128, 214);"><b>HELIOPHYSICS VIRTUAL OBSERVATORY</b></h4>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<center><h3 style="color:rgb(60, 128, 214);"><b>SOLAR POLAR FIELD STRENGTH</b></h3>
<?php
$line2 = $_GET["birthday"];
$line = $_GET["birthday2"];
...
<?php
$myfile2 = fopen("SFS/E.txt", "w") or die("Unable to open file!");
$line2 = $_GET["birthday"];
$line = $_GET["birthday2"];
...
<button><type="button"><a href="SFS/SFSRANGE/SFSRange.root">ROOT File</a></button>
</center>
