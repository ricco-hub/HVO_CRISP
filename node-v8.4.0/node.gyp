    ...
    "targets": [
        {
            ...
            "dependencies": ["node_js2c#host", "deps/nghttp2/nghttp2.gyp:nghttp2"],
            "includes": ["node.gypi"],
            "include_dirs": [
                "src",
                "tools/msvs/genfiles",
            ...
            "sources": [
                ...
                "src/tracing/trace_event.h" "src/tree.h",
                "src/util.h",
                "src/util-inl.h",
                    ...
                    'node_use_dtrace=="true" and OS!="mac" and OS!="linux"',
                    {
                        "actions": [
                            ...
                            },
                            {
                                ...
                                "outputs": ["<(OBJ_DIR)/node/src/node_dtrace_ustack.o"],
                                "conditions": [
                                    [
        ...
        },
        {
            ...
            "conditions": [
                ...
                ['OS=="solaris"', {"ldflags": ["-I<(SHARED_INTERMEDIATE_DIR)"]}],
            ],
        },
    ],  # end targets
    "conditions": [
