...
LLVM_BUILD_PATH = os.path.join(
    CHROME_SRC, "third_party", "llvm-build", "Release+Asserts"
)
CLANG_UPDATE_PY = os.path.join(CHROME_SRC, "tools", "clang", "scripts", "update.py")
...
def main():
    ...
    subprocess.check_call(
        ["python", GSUTIL_PATH, "cp", remote_path, targz_name],
