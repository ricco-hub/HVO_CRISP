...
class StatusFileTest(unittest.TestCase):
    def test_eval_expression(self):
        ...
        self.assertTrue(
            statusfile._EvalExpression("system==linux and mode==release", variables)
        )
        self.assertTrue(
            statusfile._EvalExpression("system==linux or variant==default", variables)
        )
        self.assertFalse(
        ...
        self.assertEquals(
            ...
            statusfile._EvalExpression("system==linux and variant==default", variables),
        )
