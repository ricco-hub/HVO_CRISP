...
ignore_regex = re.compile(
    "^.*\.(vcxproj|filters|nrm|icu|dat|xml|txt|ac|guess|m4|in|sub|py|mak)$"
)
...
dst_datafile = os.path.join(
    ...
    "data",
    "in",
    "icudt%s%s.dat" % (icu_ver_major, icu_endianness),
)
...
print >> fi, "It is a strict subset of ICU %s source files with the following exception(s):" % (
    icu_ver_major
)
