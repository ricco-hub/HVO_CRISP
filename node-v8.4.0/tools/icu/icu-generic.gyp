                        ...
                        "conditions": [
                            [
                                ...
                                {  # and OS=win
                                    ...
                                    "sources": [
                                        "<(SHARED_INTERMEDIATE_DIR)/icudt<(icu_ver_major)<(icu_endianness)_dat.obj"
                                    ],
                                    ...
                                    "actions": [
                                        {
                                            ...
                                            "action": [
                                                ...
                                                "icutrim.py",
                                                "-P",
                                                "<(PRODUCT_DIR)/.",  # '.' suffix is a workaround against GYP assumptions :(
                                                "-D",
                                                "<(icu_data_in)",
                                                "--delete-tmp",
                                                "-T",
                                                "<(SHARED_INTERMEDIATE_DIR)/icutmp",
                                                "-F",
                                                "icu_small.json",
                                                "-O",
                                                "icudt<(icu_ver_major)<(icu_endianness).dat",
                                                "-v",
                                                "-L",
                                                "<(icu_locales)",
                                            ],
                        ...
                        "conditions": [
                            [
                                'icu_small == "false"',
                                {
                                    # full data - just build the full data file, then we are done.
                                    "sources": [
                                        "<(SHARED_INTERMEDIATE_DIR)/icudt<(icu_ver_major)_dat.c"
                                    ],
                                    "dependencies": [
                                        "genccode#host",
                                        "icupkg#host",
