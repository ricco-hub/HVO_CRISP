...
quiet_cmd__var_www_matissewebsite_node_v8_4_0_deps_v8_src_inspector_inspector_gyp_protocol_compatibility_target_protocol_compatibility = ACTION Generating inspector protocol sources from protocol json definition $@
cmd__var_www_matissewebsite_node_v8_4_0_deps_v8_src_inspector_inspector_gyp_protocol_compatibility_target_protocol_compatibility = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/src/inspector; mkdir -p $(obj)/gen/src; python ../../third_party/inspector_protocol/CheckProtocolCompatibility.py --stamp "$(obj)/gen/src/js_protocol.stamp" js_protocol.json
...
$(obj)/gen/src/js_protocol.stamp: $(srcdir)/deps/v8/src/inspector/js_protocol.json FORCE_DO_CMD
	$(call do_cmd,_var_www_matissewebsite_node_v8_4_0_deps_v8_src_inspector_inspector_gyp_protocol_compatibility_target_protocol_compatibility)

all_deps += $(obj)/gen/src/js_protocol.stamp
action__var_www_matissewebsite_node_v8_4_0_deps_v8_src_inspector_inspector_gyp_protocol_compatibility_target_protocol_compatibility_outputs := $(obj)/gen/src/js_protocol.stamp
