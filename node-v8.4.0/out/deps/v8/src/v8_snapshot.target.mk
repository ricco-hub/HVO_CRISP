...
quiet_cmd__var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION _var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot $@
cmd__var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/src; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" ""
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,_var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
action__var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
...
$(OBJS): | $(action__var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(obj).target/deps/v8/src/libv8_snapshot.a: | $(action__var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__var_www_matissewebsite_node_v8_4_0_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(builddir)/mksnapshot $(obj).target/deps/v8/src/js2c.stamp
