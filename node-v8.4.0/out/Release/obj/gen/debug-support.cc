...
int v8dbg_parent_BreakPointInfo__Tuple2 = 0;
...
int v8dbg_parent_SloppyArgumentsElements__FixedArray = 0;
...
int v8dbg_class_JSArgumentsObject__length__Object = JSArgumentsObject::kLengthOffset;
int v8dbg_class_JSSloppyArgumentsObject__callee__Object = JSSloppyArgumentsObject::kCalleeOffset;
...
int v8dbg_class_Script__preparsed_scope_data__PodArray_uint32_t_ = Script::kPreParsedScopeDataOffset;
...
int v8dbg_class_JSAsyncGeneratorObject__await_input_or_debug_pos__Object = JSAsyncGeneratorObject::kAwaitInputOrDebugPosOffset;
