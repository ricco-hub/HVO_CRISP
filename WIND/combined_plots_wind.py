...
download_csv_button.js_on_click(
    CustomJS(
        ...
        code=js_callbacks
        + """
        downloadAxes(source, x_range.start, x_range.end, y_range.start, y_range.end, plots, "csv", "Wind");
        """,
    )
)
...
download_txt_button.js_on_click(
    CustomJS(
        ...
        code=js_callbacks
        + """
        downloadAxes(source, x_range.start, x_range.end, y_range.start, y_range.end, plots, "txt", "Wind");
        """,
    )
)
